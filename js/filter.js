...
(function () {
   ...
   * filterByType - Фильтрует объявления ads по типу жилья.
     *
     * @param  {Array} ads         Массив объявлений до фильтрации.
     * @param  {string}     filterValue Тип жилья.
     * @return {Array}             Массив объявлений после фильтрации.
     */
  ...
  filtersContainer.addEventListener('change', function () {
    window.util.debounce(window.map.updateMap, DEBOUNCE_INTERVAL);
  });
