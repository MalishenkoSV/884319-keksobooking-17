...
/**
 * Создает рандомнщу число из массива
...
for (var i = 0; i < COUNT; i++) {
  var advert = createData(advertData.author, advertData.offer, advertData.location);
  adverts.push(advert);
}
...
var createMapPin = function (pinData) {
  if (advertData) {
    ...
    pinTemplate.style = 'left:' + advertData.location.x + 'px;top:' + advertData.location.y + 'px;';
